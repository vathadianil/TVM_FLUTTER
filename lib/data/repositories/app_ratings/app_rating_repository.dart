...
class AppRatingRepository extends GetxController {
  static AppRatingRepository get instance => Get.find();

  Future<LoginModel> postRating(payload, String authToken) async {
    try {
      final data = await THttpHelper.post(
        '${ApiEndPoint.appRating}?auth_token=$authToken',
        payload
      );
